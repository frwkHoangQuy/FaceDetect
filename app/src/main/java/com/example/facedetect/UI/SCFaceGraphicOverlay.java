 ...
 * </ol>
 */
public class SCFaceGraphicOverlay extends View {
     ...
     * instances to the overlay using {@link SCFaceGraphicOverlay#add(Graphic)}.
     */
    public abstract static class Graphic {
        protected final SCFaceGraphicOverlay overlay;

        public Graphic(SCFaceGraphicOverlay overlay) {
    ...
    public SCFaceGraphicOverlay(Context context, AttributeSet attrs) {
        super(context, attrs);
